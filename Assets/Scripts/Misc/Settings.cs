...
public static class Settings
{
    ...
    public const int maxChildCorridors = 3; // Max number of child corridors leading from a room.
                                            // - maximum should be 3 although this is not recommended since it can cause the dungeon
                                            // to fail since rooms are more likely to not fit together
    ...
    public const float useAimAngleDistance = 3.5f; // If the target distance is less than this then the aim angle will be used
                                                   // (calculated from player), else the weapon aim angle will be used (calculated from the weapon)
    #endregion
