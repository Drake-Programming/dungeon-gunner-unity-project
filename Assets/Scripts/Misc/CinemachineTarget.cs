...
public class CinemachineTarget : MonoBehaviour
{
    ...
    /// <summary>
    /// Set the cinemachine camera target gropup
    /// </summary>
    private void SetCinemachineTargetGroup()
    {
        ...
        CinemachineTargetGroup.Target cinemachineGroupTarget_player = new CinemachineTargetGroup.Target { weight = 1f, radius = 2.5f, target = 
            GameManager.Instance.GetPlayer().transform };

        CinemachineTargetGroup.Target cinemachineGroupTarget_cursor = new CinemachineTargetGroup.Target { weight = 1f, radius = 1f, target = 
            cursorTarget };
