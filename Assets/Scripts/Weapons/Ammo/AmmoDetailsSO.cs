...
public class AmmoDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate with the prefab to be used for the ammo. If multiple prefabs are specified then a " +
        "random prefab from the array will be selected. The prefab can be an ammo pattern - as long as it conforms to the IFireable interface")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("If the ammo should 'charge' briefly before moving then set the time in seconds that the ammo " +
        "is held charging after firing before release")]
    #endregion Tooltip
    ...
    #endregion
    #region Tooltip
    [Tooltip("The scriptable object that defines the parameters for te hit effect prefab")]
    #endregion Tooltip
    ...
    #endregion
    #region Tooltip
    [Tooltip("This is the minimum number of ammo that are spawned per shot. A random number of ammo are " +
        "spawned between the minimum and maximum values")]
    #endregion Tooltip
    public int ammoSpawnAmountMin = 1;

    #region Tooltip
    [Tooltip("This is the maximum number of ammo that are spawned per shot. A random number of ammo are " +
        "spawned between the minimum and maximum values")]
    #endregion Tooltip
    public int ammoSpawnAmountMax = 1;

    #region Tooltip
    [Tooltip("Minimum spawn interval time. The time interval in seconds between spawned ammo is a " +
        "random value between the minimum and maximim values specified.")]
    #endregion Tooltip
    public float ammoSpawnIntervalMin = 0f;

    #region Tooltip
    [Tooltip("Maximum spawn interval time. The time interval in seconds between spawned ammo is a " +
        "random value between the minimum and maximim values specified.")]
    #endregion Tooltip
