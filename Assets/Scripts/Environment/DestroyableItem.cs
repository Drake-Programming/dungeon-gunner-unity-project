...
public class DestroyableItem : MonoBehaviour
{
    ...
    /// <summary>
    /// Handles health event when item loses health and plays breaking animation
    /// </summary>
    ...
    /// <summary>
    /// Coroutine that destroys item with it's components and plays destroyed animation
    /// </summary>
    /// <returns></returns>
