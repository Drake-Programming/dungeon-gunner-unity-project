...
public class PoolManager : SingletonMonobehaviour<PoolManager>
{
    ...
    /// <summary>
    /// Reuse a gameobject component in the pool. 'prefab' is the prefab gameobject containing the component. 'position' is the 
    /// world position for the gameobject where it should appear when enabled. 'rotation' should be set if the gameobject needs to be rotated.
    /// </summary>
    /// <param name="prefab"></param>
