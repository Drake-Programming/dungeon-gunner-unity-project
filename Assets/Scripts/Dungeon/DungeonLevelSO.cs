...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("Populate the lust with the room templates that you want to be part of the level. " +
        "You need to ensure that room templates are included for all room node types that are " +
        "specified in the Room Node Graphs for the level.")]
    #endregion Tooltip
