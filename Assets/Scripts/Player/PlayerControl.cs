...
public class PlayerControl : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // If the player is rolling, return
    ...
    /// <summary>
    /// Triggers fire weapon event if player pressed left mouse button
    /// </summary>
    /// <param name="weaponDirection"></param>
    /// <param name="weaponAngleDegrees"></param>
    /// <param name="playerAngleDegrees"></param>
    ...
    /// <summary>
    /// Checks and sets weapon by index
    /// </summary>
    ...
    private void ReloadWeaponInput()
    {
        ...
        if (currentWeapon.weaponClipRemainingAmmo == currentWeapon.weaponDetails.weaponClipCapacity) return;
    ...
    {
        // If collided with something stop roll coroutine
