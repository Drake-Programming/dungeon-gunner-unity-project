...
public class EnemyMovementAI : MonoBehaviour
{
    ...
    private void MoveEnemy()
    {
        ...
        // If the movement cooldown timer reached or player has moved more than required distance then
            ...
            GameManager.Instance.GetPlayer().GetPlayerPosition()) > Settings.playerMoveDistanceToRebuildPath))
        {
            ...
            // Move the enemy using AStar pathing - Trigger rebuild of path to player
            CreatePath();
